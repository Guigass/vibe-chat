...
| R-20 | Drift entre `.env.example`, Compose e appsettings | A | Alto | B-105 + catálogo canônico; B-187 leva integração ao admin (infra fica no env); smoke do profile `apps`; declarar aliases sem efeito | Infra / Docs |
