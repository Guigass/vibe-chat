...
- **Fase:** Wave 10 — W10-9 / B-103 Done (acessibilidade WCAG 2.2 AA); seguinte W10-10 / B-040
...
- **Próximo item elegível:** W10-10 / B-040 (guests por convite)
...
2. avançar Wave 10 (W10-1…W10-9 Done; seguinte W10-10 / B-040);
...
| Ordem | Item | Motivo |
|-------|------|--------|
| 1 | W10-10 / B-040 | P2-1, W10-4 e D-07 Done |
...
W10-8 / B-102 **Done** (seguir thread: auto-follow autor/resposta/menção na mesma
transação de `MessageWriter.SendAsync`/criação de thread; `thread_subscriptions`
com não lidas derivadas de `ConversationSequences - LastReadSeq`; `followAllThreads`
...
W10-9 / B-103 **Done** (acessibilidade WCAG 2.2 AA: skip link, landmarks, foco
contido/restaurado em overlays, contraste AA nos dois temas, anunciador resumido
sem copiar o corpo da mensagem; axe-core como gate na CI nas telas de login,
shell, thread e admin).
...
- 90 itens `Planned` entre W8–W19 (B-103/W10-9 Done; B-188/W10-16 — busca versátil, fecha BUG-023; B-186/W10-15 — membros do canal; B-178…B-183
