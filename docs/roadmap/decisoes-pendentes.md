...
|----|---------|-----------------|----------------|--------|
| D-01 | **Licença open-source** (MIT, Apache-2.0, AGPL-3.0, etc.) | Define adoção, SaaS wrappers, obrigações de copyleft | Founder / Legal | Pendente |
...
| D-09 | **Código de conduta e governança de contribuição** | OSS saudável | Founder | Pendente |
