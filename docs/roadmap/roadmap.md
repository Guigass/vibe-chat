...
Wave 6 entregue (B-068/B-069/B-067/B-073/B-074) + B-048 webhooks + B-045 suggest-reply + B-046 export. Próximo backlog: P2 restante (ex.: B-040 guests, B-047 retenção).
