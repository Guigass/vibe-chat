...
Detalhe em `docs/roadmap/roadmap.md` (Wave 6) e `docs/roadmap/backlog.md` (P1.5 / B-067+).
...
| Secrets / integrações | Tokens, webhooks, AI/SMTP só para administradores (B-069, B-048) | Planned |
| Auditoria de conversas | Viewer ADMIN completo por canal/DM/thread, além do audit log de ações (B-067) | Planned |
