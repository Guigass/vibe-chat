...
| UI | Polish admin com tokens VibeChat (B-073 histórico; **B-104** remove PrimeNG / D-15 + D-16 spartan) | B-073 Done; **B-104 Planned** — sair do PrimeNG; kit OSS = spartan/ui |
